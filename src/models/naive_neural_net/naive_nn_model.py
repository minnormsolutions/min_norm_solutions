...
class cnn_AWZY_mono_for_dsprite(nn.Module):

    def __init__(self, train_params):
        super(cnn_AWZY_mono_for_dsprite, self).__init__()
        ...
        # MLP, plus 3 dimensions for Z
        self.fc1 = nn.Linear(256+3, 64)
        self.fc2 = nn.Linear(64, 16)
        self.fc3 = nn.Linear(16, 1)

    def forward(self, A, W, Z):
        # A head
...
class cnn_AY_mono_for_dsprite(nn.Module):

    def __init__(self, train_params):
        super(cnn_AY_mono_for_dsprite, self).__init__()
        self.train_params = train_params
        self.batch_size = train_params["batch_size"]
