...
from src.data.ate.data_class import (PVTestDataSet, PVTrainDataSet,
                                     split_train_data)
from src.utils.jax_utils import (Hadamard_prod, cal_loocv_alpha, cal_loocv_emb,
                                 mat_mul, mat_trans, modif_kron,
                                 stage2_weights)
from src.utils.kernel_func import (AbsKernel, BinaryKernel,
                                   ColumnWiseGaussianKernel, GaussianKernel)
...
def kpv_experiments(data_config: Dict[str, Any], model_param: Dict[str, Any],
    ...
    pred = model.predict(test_data.treatment).flatten()
